...
2. [실습용 주피터 노트북](https://shorturl.at/bduMm)을 다운받는다. ([여기](https://colab.research.google.com/github/combio-dku/scoda_explorer/blob/main/scoda_viz_practice_workshop_v2.ipynb)를 클릭하여 바로 Colab에서 열어도 됨)
