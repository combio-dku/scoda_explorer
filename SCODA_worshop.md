...
## 진행 순서
1. SCODA를 이용한 단일세포 RNA-seq 분석 개요 (10:30-12:00)
2. AnnData 포맷 소개, SCANPY를 이용한 전처리, 세포유형식별 실습 (13:00-14:20)
3. CNV와 Ploidy 추정, 세포간 상호작용 분석 (14:35-15:55)
4. DEG 분석, 마커탐색, Gene Set Enrichment 분석 (16:10-17:30)
