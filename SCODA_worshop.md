...
### ${\color{blue} \rm{진행 \space 순서}}$
1. SCODA 간략 소개 (10분)
2. 데이터 준비 및 SCODA 실행 (1시간 10분)
3. SCODA 결과 데이터 마이닝 (1시간 40분)

### ${\color{blue} \rm{데이터 준비, SCODA 실행, 주피터 사용하기 (파이썬 간략 소개), SCODA 결과 다운 받기}}$ (1시간 10분)
1. 입력 데이터 포맷팅 소개 (5분)
...
### ${\color{blue} \rm{SCODA 결과 들춰보기}}$ (1시간 40분)
