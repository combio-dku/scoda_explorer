...
- __교육 대상:__ &nbsp;&nbsp; NGS 데이터를 이용한 바이오인포매틱스 분석 흐름을 실습하려는 학부생, 대학원생, 연구원
- __교육 목표:__ &nbsp;&nbsp; WES 변이 분석, short-read bulk RNA-seq 분석, PacBio long-read RNA-seq 분석의 기본 파이프라인을 Colab 환경에서 실습하고 주요 파일 형식과 분석 결과를 해석할 수 있도록 한다
...
## 실습 자료
1. &nbsp;&nbsp; [실습 A 주피터 노트북](https://colab.research.google.com/github/combio-dku/scoda_explorer/blob/main/Notebooks/Bi_practice_A_WES_v07_251215.ipynb): 여러가지 기본 파일 형식들, Whole Genome/Exome Seq., read alignment, variant calling, copy number variation analysis
