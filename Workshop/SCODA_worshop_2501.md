...
2. (미리 SCODA로 처리한) [실습데이터](https://drive.google.com/file/d/1XbX8Q3dH1kOWnM6ppms4BR2ukEAKYisB/view?usp=sharing)를 다운받아 본인의 구글 드라이브의 적당한 폴더에 업로드한다. (💡 이제는 Jupyter notebook에서 바로 다운받을 수 있어서 요부분은 skip해도 됩니다.)
