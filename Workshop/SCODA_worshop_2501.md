...
## 참고 논문 (SCODA 활용 사례)
1. SCODA를 이용한 자가면역질환(만성 대장염) 연구: [Integrative analysis of single-cell RNA-seq and gut microbiome metabarcoding data elucidates macrophage dysfunction in mice with DSS-induced ulcerative colitis](https://www.nature.com/articles/s42003-024-06409-w). __처리된 데이터 다운로드__ [Processed data](https://figshare.com/articles/dataset/SCODA_result_for_GSE264408/28235234)
